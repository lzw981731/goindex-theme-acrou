...
[go2index/index.js](https://github.com/lzw981731/goindex-theme-acrou/go2index) is the content of the Workers script.  
...
5. Download `index.js` in https://github.com/lzw981731/goindex-theme-acrou/tree/master/go2index and replace `client_id`,`client_secret`,`refresh_token` for what you just got.
...
- Fix image file actions does not work [#100](https://github.com/lzw981731/goindex-theme-acrou/issues/100)
- Fix misjudged file to image format [#88](https://github.com/lzw981731/goindex-theme-acrou/issues/88)
- Fix more than 10 drive not working [#59](https://github.com/lzw981731/goindex-theme-acrou/issues/59) [#85](https://github.com/lzw981731/goindex-theme-acrou/issues/85)
- Fix some of the operation functions in the search list cannot be used
- Fix text cache content not refreshing
- Add video default player([plyr](https://github.com/sampotts/plyr)) [#22](https://github.com/lzw981731/goindex-theme-acrou/issues/22) [#38](https://github.com/lzw981731/goindex-theme-acrou/issues/38)
- Add audio player ([APlayer](https://github.com/MoePlayer/APlayer)) [#77](https://github.com/lzw981731/goindex-theme-acrou/issues/77)
- Add copy button to video page
- Add [NProgress](https://github.com/rstacruz/nprogress)
- Add language cache cleanup
- Add shortcut can't download tip [#76](https://github.com/lzw981731/goindex-theme-acrou/issues/76)
...
- Solve the problem that files that can't be previewed can't be downloaded directly by clicking [#30](https://github.com/lzw981731/goindex-theme-acrou/issues/30)
- Solve the problem that the file name cannot be opened [#20](https://github.com/lzw981731/goindex-theme-acrou/issues/20)
- Solve the problem that switching pages will fall back in the current page loading [#37](https://github.com/lzw981731/goindex-theme-acrou/issues/37) (Thanks [@PedroZhang](https://github.com/PedroZhang) Help to find out the cause of the problem)
...
- Replace text editor
- Solve the problem of URL encoding [#20](https://github.com/lzw981731/goindex-theme-acrou/issues/20) [#23](https://github.com/lzw981731/goindex-theme-acrou/issues/23) [#25](https://github.com/lzw981731/goindex-theme-acrou/issues/25)
